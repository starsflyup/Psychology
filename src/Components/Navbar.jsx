    ...
    <header className={`h-24 sm:h-32 flex items-center z-30 w-full bg-${navColor}`}>
      <div className="container mx-auto px-0 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <nav className="font-alike text-white text-[20px] dark:text-white text-lg lg:flex items-center hidden">
            ...
            <a href="#" className="py-2 px-1 flex text-[16px] hover:text-[#362D64] relative bottom-6 left-10">
              <LangSwitch />
            </a>
          </nav>
